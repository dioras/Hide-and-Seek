...
public class Target : MonoBehaviour
{
    ...
    [SerializeField] private bool needBoxIndicator;

    [Tooltip("Select if arrow indicator is required for this target")]
    [SerializeField] private bool needArrowIndicator;

    [Tooltip("Select if distance text is required for this target")]
    [SerializeField] private bool needDistanceText;
    ...
    public void SetNeedArrowIndicator(bool state)
    {
        this.needArrowIndicator = state;
    }
}
